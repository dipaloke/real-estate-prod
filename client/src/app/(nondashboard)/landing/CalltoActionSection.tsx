  ...
  return (
    <div className="relative py-24">
      <Image
        ...
        alt="Rently Pro Search Section Background"
        fill
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0 md:mr-10">
              <h2 className="text-2xl font-bold text-white">
                Ready to find your Dream Rental Property?
              </h2>
            </div>
            <div>
              <p className="text-white mb-3">
                Join our community of renters and discover a wide range of
                rental properties tailored to your lifestyle needs.
              </p>
